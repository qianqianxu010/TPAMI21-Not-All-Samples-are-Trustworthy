...
from utils import LFWDataSet, LFWImgDataSet, OutlierLossL2, OutlierLossLogistic, Identity
...
parser.add_argument('--modname', type=str, default='lfw', help='model_name')
parser.add_argument('--voted', default=False, action='store_true',
                    help='if training data are voted')
parser.add_argument('--test_file', type=str, default='data/test_lfw.txt',
                    help='test set filename')
parser.add_argument('--val_file', type=str, default='./data/val_lfw.txt',
...
train_pair_data_with_img = LFWDataSet(txt=train_file,
...
train_pair_data_wo_img = LFWDataSet(txt=train_file,
...
train_img_data = LFWImgDataSet(txt=train_file,
                               transform=train_transform)
...
val_data = LFWDataSet(txt=args.val_file,
...
print('Training sample number: {}'.format(all_pair_num))
...
# compute the scores for all the images
